"""Build the attack_deputy submission notebook: embeds the current attack_deputy.py
(base64), cloning the submission_priv notebook structure/kernel id.

Usage:  python tools/build_deputy_nb.py
Outputs submission_deputy/ next to the other submission dirs.
"""
